/*
 WRF-Chem to KPP coupler (WKC)
  ...
  注意原本的官方文档有问题，它把下面的函数顺序放反了，导致会报错函数声明无效，我修改后的才是正确的顺序，下面是正确的顺序
  The /chem/KPP/util/wkc/gen_kpp.c under the chem of many official WRF versions is wrong (this is still wrong in the latest version of WRF until 2023.4.27),
  because the order of functions is reversed , put write_list_to_screen, screen_out and check_all at the bottom, but put the gen_kpp function at the top,
  so it will cause the error functions are implicit declaration, so you need to change the order of the functions in the original file, 
  please put 'write_list_to_screen' 'screen_out','check_all' over top of gen_kpp. Here is the modified correct gen_kpp.c file in my github, you can use it.
.....................................................................
